...
Before a run starts, dashed rings on the painting surface project the first 24 calculated impacts. They update live as valid controls change, are generated by a separate deterministic simulation, and disappear when the real run begins.
