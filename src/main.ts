      ...
      <aside class="panel" aria-label="Project controls">
        <section class="control-section">
          ...
          <form id="pendulum-form">
            ...
            <div class="field field-pair"><div><label for="color">Paint</label><input id="color" name="paintColor" type="color"></div><div><label for="paint-amount">Paint (ml)</label><input id="paint-amount" name="initialPaintMilliliters" type="number" min="1" max="10000" step="5"></div></div>
